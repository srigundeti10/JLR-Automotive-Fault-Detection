...
def get_featuredata(main_file):
    ...
    for file_id in main_file['FileID']:
        ...
        all_features = wavelet_features + other_features
...
train_df = pd.read_csv('C:/Users/Dhruv Agarwal/jaguar-land-rover-problem-statement-1/ps2/train.csv')
...
test_df = pd.read_csv('C:/Users/Dhruv Agarwal/jaguar-land-rover-problem-statement-1/ps2/test.csv')
